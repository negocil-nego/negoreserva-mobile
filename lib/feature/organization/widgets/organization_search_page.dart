...
class _OrganizationSearchPageState extends State<OrganizationSearchPage> {
  late final OrganizationSearchViewModel _viewModel;
  final TextEditingController _searchController = TextEditingController();

  @override
  void initState() {
    super.initState();
    _viewModel = OrganizationSearchViewModel();
    _viewModel.search('');
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Pesquise e encontre as melhores organizações.',
                style: TextStyle(
                  fontSize: 13,
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Pesquise por organizações...',
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: GetOrganizationResponseCard(
                            item: item,
                            onTap: () {
                              // Organization profile view action
                            },
                          ),
                        );
                      },
